...
class Coin:
	...
	func get_store_description() -> String:
		...
		elif _coin_family.power == Power.REFLIP:
...
var POSEIDON_FAMILY = CoinFamily.new(" of Poseidon", "Rattle the Earth", [2, 8, 18, 32], [0, 0, 0, 0], [1, 2, 3, 4], Power.NONE, "Quake", [1, 2, 3, 4])
var DEMETER_FAMILY = CoinFamily.new(" of Demeter", "Grow Ever Higher", [2, 8, 18, 32], [0, 0, 0, 0], [1, 2, 3, 4], Power.NONE, "Revitalize", [1, 2, 3, 4])
var APOLLO_FAMILY = CoinFamily.new(" of Apollo", "Arrow of Light", [2, 8, 18, 32], [0, 0, 0, 0], [1, 2, 3, 4], Power.NONE, "Arrow", [1, 2, 3, 4])
var ARTEMIS_FAMILY = CoinFamily.new(" of Artemis", "The Wild Moon", [2, 8, 18, 32], [0, 0, 0, 0], [1, 2, 3, 4], Power.NONE, "Sacrifice", [1, 2, 3, 4])
var ARES_FAMILY = CoinFamily.new(" of Ares", "Chaos of War", [2, 8, 18, 32], [0, 0, 0, 0], [1, 2, 3, 4], Power.NONE, "War", [3, 4, 5, 6])
var ATHENA_FAMILY = CoinFamily.new(" of Athena", "Patience, and Wisdom", [2, 8, 18, 32], [0, 0, 0, 0], [1, 2, 3, 4], Power.NONE, "Wisdom", [1, 2, 3, 4])
var HEPHAESTUS_FAMILY = CoinFamily.new(" of Hephaestus", "Forged in Fire", [2, 8, 18, 32], [0, 0, 0, 0], [1, 2, 3, 4], Power.NONE, "Forge", [1, 2, 3, 4])
var APHRODITE_FAMILY = CoinFamily.new(" of Aphrodite", "Moment of Warmth", [2, 8, 18, 32], [0, 0, 0, 0], [1, 2, 3, 4], Power.NONE, "Recharge", [1, 2, 3, 4])
var HERMES_FAMILY = CoinFamily.new(" of Hermes", "From Distant Lands", [2, 8, 18, 32], [0, 0, 0, 0], [1, 2, 3, 4], Power.NONE, "Exchange", [1, 2, 3, 4])
var HESTIA_FAMILY = CoinFamily.new(" of Hestia", "A Comforting Hearth", [2, 8, 18, 32], [0, 0, 0, 0], [1, 2, 3, 4], Power.NONE, "Bless", [1, 2, 3, 4])
var DIONYSUS_FAMILY = CoinFamily.new(" of Dionysus", "Baleful Revelry", [2, 8, 18, 32], [0, 0, 0, 0], [1, 2, 3, 4], Power.NONE, "Offering", [1, 2, 3, 4])
var HADES_FAMILY = CoinFamily.new(" of Hades", "Dragged into Nowhere", [2, 8, 18, 32], [0, 0, 0, 0], [1, 2, 3, 4], Power.NONE, "Destroy", [1, 2, 3, 4])

func random_god_coin_type() -> CoinFamily:
	return choose_one([ZEUS_FAMILY, HERA_FAMILY])
