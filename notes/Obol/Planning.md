...
- [ ] **Active Goals - Mar 9 Sprint - More Content**
	- [ ] **More Coins**
		- [ ] Week:
			...
			- [ ] supercharge and blank need to be handled like other statuses (they need a state) instead of bool to work properly with permanent.
				- [ ] Make blank/supercharge possible permanent statuses.
