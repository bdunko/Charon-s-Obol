...
class Effect:
	...
	func _init(res: Array, maxinstances: int) -> void:
		resource = res
...
var CoinLanding = Effect.new([preload("res://assets/audio/sounds/SFX CoinLanding.wav"), preload("res://assets/audio/sounds/SFX CoinLanding2.wav"), preload("res://assets/audio/sounds/SFX CoinLanding3.wav")], 3)
...
var CharonMaliceSlam = Effect.new([preload("res://assets/audio/sounds/SFX MajorButton.wav")], 1)
var CharonTalk = Effect.new([preload("res://assets/audio/sounds/SFX CharonTalk.wav")], 1)

# looping
var CharonMaliceCasting = Effect.new([preload("res://assets/audio/sounds/SFX CharonMaliceCastingAudio.wav")], 1)
var HeavyWater = Effect.new([preload("res://assets/audio/sounds/SFX HeavyWater.wav")], 1)
var Windstorm = Effect.new([preload("res://assets/audio/sounds/SFX Windstorm.wav")], 1)
var Windstorm2 = Effect.new([preload("res://assets/audio/sounds/SFX Windstorm2.wav")], 1)
var VictoryBirds = Effect.new([preload("res://assets/audio/sounds/SFX VictoryBirdsCombined.wav")], 1)
